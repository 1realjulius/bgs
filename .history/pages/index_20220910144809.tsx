    ...
    <div className="flex min-h-screen flex-col bg-blue-50 items-center justify-center">
      ...
      <div>
        <div className="flex flex-row relative items-center justify-center">
          <div className="absolute rounded-full h-40 w-40 right-2  mix-blend-multiply filter bg-blue-400"></div>
          <div className="absolute rounded-full h-40 w-40  mix-blend-multiply filter bg-red-400"></div>
          <div className="absolute rounded-full h-40 w-40  mix-blend-multiply filter left-2 bg-yellow-400"></div>
        </div>
      </div>
    </div>
  );
