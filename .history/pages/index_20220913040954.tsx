  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-blue-50">
      ...
      <div className="relative  flex flex-row">
        <div className="left-50 absolute h-40 w-40 bg-blue-200"></div>
        <div className="absolute h-40 w-40 bg-green-200"></div>
        <div className="absolute h-40 w-40 bg-red-200"></div>
        <h1 className="absolute text-5xl">The webnceo of the websites</h1>
      </div>
    </div>
  );
};
