...
const Home: NextPage = () => {
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center bg-black">
      ...
      <div className="absolute right-2 h-80 w-80 rounded-full bg-blue-400  mix-blend-multiply blur-xl filter"></div>
      <div className="absolute h-80 w-80 rounded-full bg-red-400  mix-blend-multiply blur-xl filter"></div>
      <div className="absolute left-2 h-80 w-80 rounded-full  bg-yellow-400 mix-blend-multiply blur-xl filter"></div>
    </div>
  );
};
