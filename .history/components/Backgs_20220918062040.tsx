  ...
  return (
    <div className="absolute top-0 text-white">
      ...
      <div className="relative">
        ...
        <div className="absolute left-20 h-40 w-40 rounded-full bg-red-200 blur-xl filter"></div>
        <div className="absolute right-20 h-40 w-40 rounded-full bg-green-200 blur-xl filter"></div>
      </div>
    </div>
  );
};
